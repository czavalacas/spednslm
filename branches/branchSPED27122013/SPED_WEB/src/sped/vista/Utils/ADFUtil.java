...
public class ADFUtil {
    ...
    public static void mandarFlowScope(String key,Object val){
        //ADFContext adfFacesContext = ADFContext.getCurrent();
        AdfFacesContext adfFacesContext = AdfFacesContext.getCurrentInstance();
        Map pageFlowScope = adfFacesContext.getPageFlowScope();
        pageFlowScope.put(key,val);
    }
    
    public static Object getFlowScope(String key){
        //ADFContext adfFacesContext = ADFContext.getCurrent();
        AdfFacesContext adfFacesContext = AdfFacesContext.getCurrentInstance();
        Map pageFlowScope = adfFacesContext.getPageFlowScope();
    ...
    public static String getParameter(String parameterName){
        String parameter = FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap().get(parameterName);
        return parameter;
    }
}