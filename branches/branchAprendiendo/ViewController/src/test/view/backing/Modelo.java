...
public class Modelo extends CalendarModel implements Serializable {

    public Modelo(CalendarProvider provider) {
        _provider = provider;
     ...
     */
    private synchronized List<CalendarActivity> _getActivities(List<CalendarActivity> allActivities, Date rangeStart,
                                                               Date rangeEnd, TimeZone tz) {
    ...
    private final List<CalendarActivity> _allDayActivitiesFromThisModel = new ArrayList<CalendarActivity>();
    private final List<CalendarActivity> _allDayActivitiesFromAllModel = new ArrayList<CalendarActivity>();
    private final List<CalendarActivity> _timeActivitiesFromThisModel = new ArrayList<CalendarActivity>();
    private final List<CalendarActivity> _timeActivitiesFromAllModel = new ArrayList<CalendarActivity>();
