...
public class WS_SPED {
    ...
    public List<BeanEvaluacionWS> getPlanificaciones_WS(@WebParam(name = "arg0") int nidRol,
        ...
        if(nidRol == 1 || nidRol == 2 || nidRol == 4){//Solo Director,EvaXArea,EvaXSede y EvaGeneral pueden consultar
    ...
    public String recuperarClave(@WebParam(name = "arg0") String correo){
        String msj = ln_C_SFCorreoLocal.recuperarClave(correo,0,null/*Utils.rutaImagenes()*/);
